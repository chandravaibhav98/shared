...
import com.chandravaibhav98.jobportal.Service.JobPostActivityService;
import com.chandravaibhav98.jobportal.Service.JobSeekerApplyService;
import com.chandravaibhav98.jobportal.Service.JobSeekerSaveService;
import com.chandravaibhav98.jobportal.Service.UsersService;
...
public class JobPostActivityController {
	...
	public String searchJobs ( Model model ,
		...
		if ( ! ( authentication instanceof AnonymousAuthenticationToken ) ) {
			...
			if ( authentication.getAuthorities( ).contains( new SimpleGrantedAuthority( "Recruiter" ) ) ) {
				...
				List< RecruiterJobs > recruiterJobs =
	...
	public String addNewJob ( JobPostActivity jobPostActivity , Model model ) {
		...
		System.out.println( user.getEmail( ) + " created job : " + savedJob );

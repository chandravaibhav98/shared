								...
								<div className="row mt-3 mb-3">
									...
									<div className="card col-3 col-md-3 container d-flex">
										<div className="card-body">
											<div className="mt-3">
												<h4>Loan Options</h4>
												{shelfCurrentLoan.daysLeft > 0 && <p>Due in {shelfCurrentLoan.daysLeft} days</p>}
												{shelfCurrentLoan.daysLeft === 0 && <p className="text-success">Due Today</p>}
												{shelfCurrentLoan.daysLeft < 0 && <p>Past due by {shelfCurrentLoan.daysLeft}</p>}
											...
											<hr />
											<p>Help others find their adventure by Reviewing your loans</p>
											<Link

					...
					<div className="modal-body">
						<div className="container">
							<div className="mt-3">
								...
								<hr />
								{props.shelfCurrentLoan.daysLeft > 0 && <p>Due in {props.shelfCurrentLoan.daysLeft} days</p>}
								{props.shelfCurrentLoan.daysLeft === 0 && <p className="text-success">Due Today</p>}
								{props.shelfCurrentLoan.daysLeft < 0 && <p>Past due by {props.shelfCurrentLoan.daysLeft}</p>}
